 ...
 * @author Star3oy
 */
public class DosPorUnoController implements Initializable {
    @FXML
    ...
    void buttonCancelar(ActionEvent event) {
        try {
            ...
            Logger.getLogger(DosPorUnoController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void buttonGuardar(ActionEvent event) {
        if (isValid()) {      
              ...
              try { 
                dosPorUnoDAO.addDescuento(dosPorUno);
