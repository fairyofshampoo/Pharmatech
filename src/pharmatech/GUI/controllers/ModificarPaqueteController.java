 ...
 * @author Star3oy
 */
public class ModificarPaqueteController implements Initializable {
    ...
    void buttonCancelar(ActionEvent event) {
         try {
             ...
             Logger.getLogger(ModificarPaqueteController.class.getName()).log(Level.SEVERE, null, ex);
         }
    }
    ...
    void buttonGuardar(ActionEvent event) {
           if (isValid()) {      
              ...
              try { 
                paqueteDAO.modificarDescuento(paquete,identificador);
